...
contract SystemConfig_Setters_Test is SystemConfig_Init {
    ...
    function testFuzz_setBatcherHash_succeeds(bytes32 newBatcherHash) external {
        ...
        emit ConfigUpdate(3 << 128 | 1, ISystemConfig.UpdateType.BATCHER, abi.encode(newBatcherHash));
    ...
    function testFuzz_setGasConfig_succeeds(uint256 newOverhead, uint256 newScalar) external {
        ...
        vm.expectEmit(address(systemConfig));
        emit ConfigUpdate(3 << 128 | 1, ISystemConfig.UpdateType.FEE_SCALARS, abi.encode(newOverhead, newScalar));
    ...
    function testFuzz_setGasConfigEcotone_succeeds(uint32 _basefeeScalar, uint32 _blobbasefeeScalar) external {
        ...
        vm.expectEmit(address(systemConfig));
        emit ConfigUpdate(
            3 << 128 | 1, ISystemConfig.UpdateType.FEE_SCALARS, abi.encode(systemConfig.overhead(), encoded)
        );
    ...
    function testFuzz_setGasLimit_succeeds(uint64 newGasLimit) external {
        ...
        vm.expectEmit(address(systemConfig));
        emit ConfigUpdate(3 << 128 | 1, ISystemConfig.UpdateType.GAS_LIMIT, abi.encode(newGasLimit));
    ...
    function testFuzz_setUnsafeBlockSigner_succeeds(address newUnsafeSigner) external {
        vm.expectEmit(address(systemConfig));
        emit ConfigUpdate(3 << 128 | 1, ISystemConfig.UpdateType.UNSAFE_BLOCK_SIGNER, abi.encode(newUnsafeSigner));
